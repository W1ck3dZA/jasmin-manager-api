...
from rest_api.serializers import (
    HTTPCCMListSerializer, HTTPCCMCreateSerializer, SimpleResponseSerializer
)
...
@extend_schema(tags=['Connectors - HTTP'])
class HTTPCCMViewSet(ViewSet):
    "Viewset for managing HTTP Client Connectors"
    lookup_field = 'cid'
    serializer_class = HTTPCCMListSerializer
    ...
    @extend_schema(
        responses=HTTPCCMListSerializer,
    ...
    @extend_schema(
        ...
        responses={'connector': HTTPCCMListSerializer},
    ...
    @extend_schema(
        request=HTTPCCMCreateSerializer,
